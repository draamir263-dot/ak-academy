  ...
  return (
    <div className="min-h-screen bg-slate-900 text-white flex flex-col p-4">
      ...
      <div className="flex-1 flex flex-col justify-center max-w-2xl w-full mx-auto py-4">
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-3xl p-5 shadow-lg mb-5">
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-3xl p-4 shadow-lg mb-6">
      ...
      <div className="max-w-2xl w-full mx-auto pb-4 mt-auto">
        <div className="flex gap-3">
          <button 
            onClick={() => navigate('/')}
            className="flex-1 bg-indigo-600 text-white py-4 rounded-xl font-semibold hover:bg-indigo-700 transition-colors shadow-md shadow-indigo-600/20 flex items-center justify-center gap-2 text-sm"
          >
          ...
          <button 
            ...
            className="flex-1 bg-slate-800 border border-slate-700 text-slate-200 py-4 rounded-xl font-semibold hover:bg-slate-700 transition-colors flex items-center justify-center gap-2 text-sm"
          >
            Chapters
          </button>
        </div>
