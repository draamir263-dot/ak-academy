  ...
  return (
    <div className="relative min-h-screen aurora-bg overflow-hidden">
      <style>{`
        ...
        .about-link-row:hover { background: rgba(255,255,255,0.1); }
        .about-social-icon {
        ...
        .about-stat-divider { width: 1px; height: 36px; background: rgba(255,255,255,0.15); margin-top: 4px; }
      `}</style>
      ...
      <div className="relative z-10 max-w-xl mx-auto">
        ...
        <div className="about-card" style={{ textAlign: 'center' }}>
          ...
          <p style={{ color: '#ffe9a8', fontSize: '15px', fontStyle: 'italic', marginTop: '6px', fontWeight: 600 }}>
            Final Year MBBS Student
          </p>
          <p style={{ color: '#b8d4ff', fontSize: '13px', marginTop: '8px', lineHeight: 1.6 }}>
          ...
          <div style={{
            ...
            padding: '6px 16px', fontSize: '12px', color: '#d8f2ff',
        ...
        <div className="about-card">
          <h2 style={{ color: '#0fb8ad', fontSize: '18px', fontWeight: 700, marginBottom: '10px' }}>
            Why I Built This App
          </h2>
          <p style={{ color: '#d8f2ff', fontSize: '14px', lineHeight: 1.8 }}>
        ...
        {/* Stats */}
        <div className="about-card">
          <h2 style={{ color: '#0fb8ad', fontSize: '18px', fontWeight: 700, marginBottom: '12px' }}>
            What's Inside
          </h2>
          <div style={{ display: 'flex', alignItems: 'center' }}>
            <div className="about-stat-box">
              <div style={{ color: '#fff', fontSize: '24px', fontWeight: 800 }}>5000+</div>
              <div style={{ color: '#b8d4ff', fontSize: '12px' }}>MCQs</div>
            </div>
            <div className="about-stat-divider" />
            <div className="about-stat-box">
              <div style={{ color: '#fff', fontSize: '24px', fontWeight: 800 }}>5</div>
              <div style={{ color: '#b8d4ff', fontSize: '12px' }}>Subjects</div>
            </div>
            <div className="about-stat-divider" />
            <div className="about-stat-box">
              <div style={{ color: '#fff', fontSize: '24px', fontWeight: 800 }}>Free</div>
              <div style={{ color: '#b8d4ff', fontSize: '12px' }}>Access</div>
            </div>
          </div>
        </div>
        ...
        <div className="about-card">
          ...
          <a href="https://www.facebook.com/share/1E7srFhDDm/" target="_blank" rel="noopener noreferrer" className="about-link-row">
            <div className="about-social-icon" style={{ background: 'rgba(24,119,242,0.2)' }}>
              📘
            </div>
            <div>
              <div style={{ color: '#fff', fontSize: '15px', fontWeight: 600 }}>Facebook Page</div>
              <div style={{ color: '#b8d4ff', fontSize: '12px' }}>AK Academy</div>
            </div>
            <span style={{ marginLeft: 'auto', color: '#1877F2', fontWeight: 700, fontSize: '16px' }}>→</span>
          </a>

          <a href="https://www.tiktok.com/@medlife458" target="_blank" rel="noopener noreferrer" className="about-link-row">
            <div className="about-social-icon" style={{ background: 'rgba(255,0,80,0.15)' }}>
              🎵
            </div>
            <div>
              <div style={{ color: '#fff', fontSize: '15px', fontWeight: 600 }}>TikTok</div>
              <div style={{ color: '#b8d4ff', fontSize: '12px' }}>@medlife458</div>
            </div>
            <span style={{ marginLeft: 'auto', color: '#FF0050', fontWeight: 700, fontSize: '16px' }}>→</span>
          </a>
        </div>

        {/* Footer */}
        <div className="about-card" style={{ textAlign: 'center', background: 'rgba(255,255,255,0.08)' }}>
          <p style={{ color: '#b8d4ff', fontSize: '13px' }}>
            For any query or feedback, reach out via our social media pages.
          </p>
          <p style={{ color: '#b8d4ff', fontSize: '12px', marginTop: '8px', opacity: 0.6 }}>
